...
namespace AuctionService.Data
{
    public class DbInitializer
    {
        ...
        {
            // Create the database if it doesn't exist an apply any pending migration.
            context.Database.Migrate();

            // If there are any auctions in the database, then the database has already been seeded.
            if (context.Auctions.Any())
            {
                Console.WriteLine("Database already seeded. Skipping seeding. 🤷‍♂️");
                return;
            }
            ...
            // Add the auctions to the context memory.
